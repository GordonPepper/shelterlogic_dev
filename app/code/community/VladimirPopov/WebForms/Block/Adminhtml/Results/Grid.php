	...
	extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function decorateStatus($value, $row, $column, $isExport)
    {
        ...
        switch ($row->getApproved()){
        	case VladimirPopov_WebForms_Model_Results::STATUS_PENDING: $class = 'grid-severity-minor'; break;
        	case VladimirPopov_WebForms_Model_Results::STATUS_APPROVED: $class = 'grid-severity-notice'; break;
        	case VladimirPopov_WebForms_Model_Results::STATUS_NOTAPPROVED: $class = 'grid-severity-critical'; break;
        }
