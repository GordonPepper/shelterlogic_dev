    ...
    extends Mage_Core_Model_Abstract
{
    ...
    public function sendApprovalEmail(){
        ...
        if($this->getApproved() == self::STATUS_APPROVED){
            ...
            if($this->getData('email_result_approved_template_id')){
                $templateId = $this->getData('email_result_approved_template_id');
            }
        }
        else if($this->getApproved() == self::STATUS_NOTAPPROVED){
            $templateId = 'webforms_result_notapproved';
            if($this->getData('email_result_notapproved_template_id')){
                $templateId = $this->getData('email_result_notapproved_template_id');
            }
        }
        else 
            return false;
