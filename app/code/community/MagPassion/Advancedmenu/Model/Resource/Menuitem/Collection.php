 ...
 */
class MagPassion_Advancedmenu_Model_Resource_Menuitem_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract{
	 ...
	 * @return MagPassion_Advancedmenu_Model_Resource_Menuitem_Collection
	 * @author MagPassion.com
	 */
	...
	protected function _renderFiltersBefore(){
		if ($this->getFilter('store')) {
			$this->getSelect()->join(
				array('store_table' => $this->getTable('advancedmenu/menuitem_store')),
