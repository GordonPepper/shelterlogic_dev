 ...
 */
/**
 * Menu Group admin widget chooser
 *
 * @category	MagPassion
 * @package		MagPassion_Advancedmenu
 * @author MagPassion.com
 */
class MagPassion_Advancedmenu_Block_Adminhtml_Menugroup_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid{
	/**
	...
	public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element){
		...
		$sourceUrl = $this->getUrl('advancedmenu/adminhtml_advancedmenu_menugroup_widget/chooser', array('uniq_id' => $uniqId));
		$chooser = $this->getLayout()->createBlock('widget/adminhtml_widget_chooser')
				...
				->setUniqId($uniqId);
		if ($element->getValue()) {
			$menugroup = Mage::getModel('advancedmenu/menugroup')->load($element->getValue());
			if ($menugroup->getId()) {
				$chooser->setLabel($menugroup->getName());
			}
		}
	...
	public function getRowClickCallback(){
		...
		$js = '
			function (grid, event) {
				...
				'.$chooserJsObject.'.setElementValue(menugroupId);
				'.$chooserJsObject.'.setElementLabel(menugroupTitle);
	 ...
	 * @access protected
	 * @return MagPassion.com_Block_Adminhtml_Menugroup_Widget_Chooser
	 * @author MagPassion.com
	 */
	...
	public function getGridUrl(){
		return $this->getUrl('adminhtml/advancedmenu_menugroup_widget/chooser', array('_current' => true));
	}
	/**
