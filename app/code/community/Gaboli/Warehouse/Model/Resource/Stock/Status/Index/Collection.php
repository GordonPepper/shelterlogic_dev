<?php
/**
 * Class Gaboli_Warehouse_Model_Resource_Stock_Status_Index_Collection
 */
class Gaboli_Warehouse_Model_Resource_Stock_Status_Index_Collection
    extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    {
        $this->_init('gaboli_warehouse/stock_status_index');
    }
     ...
     *
     * @return Gaboli_Warehouse_Model_Resource_Stock_Status_Index_Collection
     */
    ...
    public function joinStockStatus($storeId = null)
    {
        ...
        $this->getSelect()->joinLeft(
            array(
                'status_table_mli' => $this->getTable('gaboli_warehouse/stock_status_index')
            ),
