...
/**
 * Class Gaboli_Warehouse_Model_Resource_Stock
 */
class Gaboli_Warehouse_Model_Resource_Stock extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('gaboli_warehouse/stock', 'stock_id');
    }

    /**
     * Load Stock object by product
     *
     * @param Gaboli_Warehouse_Model_Stock $stock
     * @param                                          $locationId
     * @param                                          $productId
     *
     * @return Gaboli_Warehouse_Model_Resource_Stock
     */
    public function loadByProduct(Gaboli_Warehouse_Model_Stock $stock, $locationId, $productId)
    {
