<?php
/**
 * Class Gaboli_Warehouse_Model_CatalogInventory_Resource_Stock_Item
 */
class Gaboli_Warehouse_Model_CatalogInventory_Resource_Stock_Item extends Mage_CatalogInventory_Model_Resource_Stock_Item
{
    /**
    ...
    public function loadByProductId(Mage_CatalogInventory_Model_Stock_Item $item, $productId)
    {
        ...
        $stockStatusCollection = Mage::getModel('gaboli_warehouse/stock_status_index')
            ->getCollection()
    ...
    public function addCatalogInventoryToProductCollection($productCollection)
    {
        $productCollection->getSelect()->joinLeft(
            array('cisi' => Mage::getSingleton('core/resource')->getTableName('gaboli_warehouse/stock_status_index')),
