<?php
/**
 * Class Gaboli_Warehouse_Model_CatalogInventory_Resource_Stock_Status
 */
class Gaboli_Warehouse_Model_CatalogInventory_Resource_Stock_Status extends Mage_CatalogInventory_Model_Resource_Stock_Status
{
    ...
    public function addIsInStockFilterToCollection($collection)
    {
        ...
        $collection->getSelect()
            ->join(
                array('status_table_mli' => $this->getTable('gaboli_warehouse/stock_status_index')),
                $joinCondition,
                array()
            )
