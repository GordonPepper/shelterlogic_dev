...
/**
 * Class Gaboli_Warehouse_Model_Location_Api
 */
class Gaboli_Warehouse_Model_Location_Api extends Mage_Catalog_Model_Api_Resource
{
    /**
     * Create location
     *
    ...
    public function create($data)
    {
        try {
            ...
            $locationItem = Mage::getModel('gaboli_warehouse/location');
    ...
    {
        $locationItem = Mage::getModel('gaboli_warehouse/location')->load($locationId);
    ...
    {
        $collection = Mage::getResourceModel('gaboli_warehouse/location_collection')->load();
    ...
    public function update($data)
    {
        try {
            ...
            $locationItem = Mage::getModel('gaboli_warehouse/location')->load($data['location_id']);
    ...
    public function getAddressInformation($locationData, $locationItem)
    {
        ...
        if((isset($locationData['address']) || isset($locationData['country'])
            ...
            $latLong = Mage::helper('gaboli_warehouse')->getLatLong($address, $country);
