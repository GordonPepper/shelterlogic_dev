...
/**
 * Class Gaboli_Warehouse_Model_Stock_Api
 */
class Gaboli_Warehouse_Model_Stock_Api extends Mage_Catalog_Model_Api_Resource
{
    ...
    public function create($data)
    {
        try {
            ...
            $stockItem = Mage::getModel('gaboli_warehouse/stock')
                ->addData($stockData)
                ->save();
            $id        = $stockItem->getId();
    ...
    {
        $ids       = (array) $ids;
        $stockItem = Mage::getModel('gaboli_warehouse/stock')->loadByProduct($ids['location_id'], $ids['product_id']);
    ...
    {
        $collection = Mage::getResourceModel('gaboli_warehouse/stock_collection');
    ...
    public function update($data)
    {
        try {
            ...
            $stockItem = Mage::getModel('gaboli_warehouse/stock')->loadByProduct($data['location_id'], $data['product_id']);
     ...
     *
     * @param Gaboli_Warehouse_Model_Resource_Stock_Collection $collection
     *
     * @return array
     */
