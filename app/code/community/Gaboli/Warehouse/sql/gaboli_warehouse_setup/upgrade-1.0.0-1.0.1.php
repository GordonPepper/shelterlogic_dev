...
$table = $installer->getConnection()
    ->newTable($installer->getTable('gaboli_warehouse/stock'))
    ...
    ->addIndex($installer->getIdxName('gaboli_warehouse/stock', array('product_id', 'location_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE),
               array('product_id', 'location_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE)
    )
    ->addForeignKey(
        $installer->getFkName('gaboli_warehouse/stock', 'location_id',
                              'gaboli_warehouse/location', 'id'), 'location_id',
        $installer->getTable('gaboli_warehouse/location'), 'id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->addForeignKey($installer->getFkName('gaboli_warehouse/stock', 'product_id',
