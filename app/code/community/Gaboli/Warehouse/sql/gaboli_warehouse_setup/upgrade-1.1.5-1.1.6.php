...
$table = $installer->getConnection()
    ->newTable($installer->getTable('gaboli_warehouse/order_stock_source'))
    ...
    ->addForeignKey($installer->getFkName(
                        'gaboli_warehouse/order_stock_source',
                        'sales_quote_item_id',
                        'sales/quote_item',
                        'item_id'
                    ),
    ...
    ->addForeignKey($installer->getFkName(
                        'gaboli_warehouse/order_stock_source',
                        'location_id',
                        'gaboli_warehouse/location',
                        'id'
                    ),
                    'location_id',
                    $installer->getTable('gaboli_warehouse/location'),
                    'id',
                    Varien_Db_Ddl_Table::ACTION_CASCADE,
                    Varien_Db_Ddl_Table::ACTION_CASCADE
    );
