...
/**
 * Class Gaboli_Warehouse_Helper_Data
 */
class Gaboli_Warehouse_Helper_Data extends Mage_Core_Helper_Abstract
{
    const CONFIG_PATH = 'gaboli_warehouse/general/';
     ...
     *
     * Uses Gaboli_Geocoding library if it is available.
     *
     * @param $postalCode
     * @param $country
     *
    ...
    /**
     * Checks if the Gaboli_Geocoding extension is available (recommended).
     *
     * @returns Boolean
