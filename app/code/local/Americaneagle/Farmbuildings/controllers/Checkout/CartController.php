	...
	Mage_Checkout_CartController
{
    ...
    public function updatePostAction() {
        ...
        foreach ($cart->getQuote()->getAllVisibleItems() as $item) {
            $currentCartWeight += $item->getRowWeight();
            if(isset($cartData[$item->getItemId()])){
                $addQty = $cartData[$item->getItemId()]['qty'] - $item->getQty();
                if($currentCartWeight + ($addQty * $item->getWeight()) > 5000) {
