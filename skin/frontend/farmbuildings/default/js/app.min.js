...
!function($) {
    ...
    !function(_NS, undefined) {
        window._local = {
            ...
            imageUrl: function() {
                if ("FabricMaterial" == _lastSelection) return _NS.loading(!1), !0;
            ...
            loading: function(start) {
                var _unLoad = function() {
                    ...
                    $(".elements").removeClass("op_5"), $("#loader").removeClass("loading"), console.log("in unload"), 
                    delete farmBuilding;
                };
                return start ? (_bod.addClass("loading"), _b.find("img#render").addClass("op_0"), 
                $(".elements .timer").addClass("show"), $(".elements").addClass("op_5"), $("#loader").addClass("loading"), 
                console.log("in start")) : _unLoad(), !0;
            },
            init: {
